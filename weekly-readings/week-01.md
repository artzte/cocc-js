...
- **Trademarks and ECMAScript**: Oracle owns the trademark for "JavaScript". The official specification name is **ECMAScript**, managed by the ECMA standards body. Modern revisions are designated by the release year (e.g., _ES2019_).
