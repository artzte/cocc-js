...
(and, getting started with our tools)
...
- Quiz on JS concepts
- Setup of assignment repositories
- Write your first test

## Activities

- Video: forking the starter kit
- Video: bootstrapping the project
- Video: writing your first test
...
- Quiz: Primitives vs objects, typeof behavior, let vs const vs var
- Challenge: Read a structured object and output its fields into a prepared HTML template
...
- Quiz: Function syntax forms and their differences, strict vs. loose equality, truthy/falsy
- Exercise: Read from a form field and output user inputs into the DOM
- Challenge: A username validator, with error feedback
